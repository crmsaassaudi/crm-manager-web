  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <motion.div
        ...
        className="w-full max-w-md bg-card border border-border rounded-4xl p-8 shadow-2xl relative z-10"
      >
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <div>
            <h1 className="text-3xl font-black tracking-tighter mb-1 bg-linear-to-br from-foreground to-foreground/70 bg-clip-text text-transparent">CRM Manager</h1>
